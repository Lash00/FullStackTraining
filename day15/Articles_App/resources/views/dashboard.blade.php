                ...
                <div class="card bg-primary text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title mt-0 mb-1">Welcome back, !</h4>
                        ...
                        @forelse($recentArticles ?? [] as $article)
                            <div class="d-flex align-items-center py-3 border-bottom">
                                <div class="flex-shrink-0">
                                    <div class="bg-secondary text-center  rounded-circle d-flex align-items-center justify-content-center"
                                        style="width: 50px; height: 50px;">
                                        <i class="bi bi-file-text text-white ">{{ $article->title }}</i>
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-1"></h6>
                                    <p class="text-muted mb-0 small">{{ $article->body }}</p>

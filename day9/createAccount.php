                ...
                <div class="card myShadow p-3">
                    ...
                    <form action=<?php echo "'" . $_SERVER['PHP_SELF'] . "'"; ?> method="post" class="was-validated "
                        ...
                        <section class="mt-4  mx-auto text-center">
                            ...
                            <a href="http://localhost/NTI/day9/login.php" class="text-light">
                                <button type="button"
                                    class="btn mt-3 bg-linear p-2 w-50 text-center border-0 myShadow mb-0 text-light">Login</button></a>';
